...
Audio taps left installed make restart crash; continuations can outlive sessions; asset downloads can delay first start; simulator recognition is not device proof; changing actor isolation can introduce races.
